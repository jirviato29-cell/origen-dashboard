...
export default function BalancePage() {
  ...
  // Caja chica = capital inicial + efectivo recibido − gastos del año (terminal va al banco, nunca entra aquí)
  ...
  // Gastos asignados a períodos semanales (puede diferir de totalGastos si hay gastos post-último domingo)
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <div className="card" style={{ padding: '20px 20px 16px' }}>
        <div className="card-head" style={{ marginBottom: 20 }}>
          <div>
            <h3 className="card-title">Balance acumulado {year} — semana a semana</h3>
            <div className="card-sub">
              {ofrendas.length} domingos · hover para ver acumulados y balance
            </div>
          </div>
