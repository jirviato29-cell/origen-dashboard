...
const navByRole = {
  ...
  [ROLES.STEWARDSHIP]: [
    { group: 'Stewardship', items: [
      ...
      { to: '/stewardship/voluntarios',       label: 'Directorio voluntarios',  icon: I.hand },
      { to: '/stewardship/calendario',        label: 'Calendario',              icon: I.calendar },
      { to: '/stewardship/equipos',           label: 'Líderes y equipos',       icon: I.heart },
...
export default function Sidebar({ onClose }) {
  ...
  const logoWidth = campusActivo === 'gdl' ? '96px' : '108px';
