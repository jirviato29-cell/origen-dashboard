...
pool.query(`ALTER TABLE visitantes ADD COLUMN IF NOT EXISTS contactado BOOLEAN DEFAULT false`)
  .catch(e => console.error('visitantes alter contactado:', e.message));
